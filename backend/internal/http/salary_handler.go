...
func (h *SalaryHandler) CreateSalary(c echo.Context) error {
	...
	_ = h.activityService.LogActivity(userID, entity.ActivityIncome, "Update Gaji",
...
func (h *SalaryHandler) UpdateSalary(c echo.Context) error {
	...
	_ = h.activityService.LogActivity(userID, entity.ActivityUpdate, "Update Gaji",
		fmt.Sprintf("Update gaji untuk %s", member.FullName))
...
func (h *SalaryHandler) DeleteSalary(c echo.Context) error {
	...
	_ = h.activityService.LogActivity(userID, entity.ActivityExpense, "Hapus Gaji",
...
func (h *SalaryHandler) DeleteDocument(c echo.Context) error {
	...
	if err == nil {
		_ = h.activityService.LogActivity(userID, entity.ActivityUpdate, "Hapus Dokumen Gaji",
...
func (h *SalaryHandler) CreateSalaryDetail(c echo.Context) error {
	...
	if err == nil {
		member, err := h.memberService.GetMemberByID(salary.MemberID)
		if err == nil {
			_ = h.activityService.LogActivity(userID, entity.ActivityIncome, "Tambah Detail Gaji",
...
func (h *SalaryHandler) UpdateSalaryDetail(c echo.Context) error {
	...
	if err == nil {
		member, err := h.memberService.GetMemberByID(salary.MemberID)
		if err == nil {
			_ = h.activityService.LogActivity(userID, entity.ActivityUpdate, "Ubah Detail Gaji",
...
func (h *SalaryHandler) DeleteSalaryDetail(c echo.Context) error {
	...
	if err == nil {
		member, err := h.memberService.GetMemberByID(salary.MemberID)
		if err == nil {
			_ = h.activityService.LogActivity(userID, entity.ActivityExpense, "Hapus Detail Gaji",
